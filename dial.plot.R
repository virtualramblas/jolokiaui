...
# Provided by http://onepager.togaware.com/dial.plot.R
# Graham.Williams@togaware.com 2013-04-06 09:55:37
...
dial.plot <- function(label="UseR!"
                      ...
                      , yellowFrom=75
                      , yellowTo=90
                      , yellow.slice.color="#FF9900"
                      , redFrom=90
                      , redTo=100
                      , red.slice.color="#DC3912"
                      , needle.color="red"
                      , needle.center.color="black"
                      , needle.center.cex=1
                      , dial.digets.color="grey50"
                      , heavy.border.color="gray85"
                      , thin.border.color="gray20"
                      , minor.ticks.color="gray55"
                      , major.ticks.color="gray45")
{
  ...
  # Get major and minor tick marks
  ...
  needle.x.points <- c(needle.end.x, needle.side1.end.x,
                       needle.short.end.x, needle.side2.end.x)
  needle.y.points <- c(needle.end.y, needle.side1.end.y,
                       needle.short.end.y, needle.side2.end.y)
